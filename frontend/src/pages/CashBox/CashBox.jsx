...
import api from './../../api/axios'; // تأكد من وجود ملف api.js
...
const CashBox = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const totalsRes = await api.get('/sales/cash/totals');
        ...
        const detailsRes = await api.get('/sales/cash/details');
  ...
  const handleAddTransaction = async (transactionData) => {
    try {
      ...
      const response = await api.post('/cash/transactions', transactionData);
